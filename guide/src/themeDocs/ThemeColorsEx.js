        ...
        return (
            <div className={classes.wrapper}>
                <Paper className={classes.swatch}>
                    ...
                    <div className={classes.primaryDark}>
                        Primary Dark
                    </div>
                ...
                <Paper className={classes.swatch}>
                    ...
                    <div className={classes.secondaryDark}>
                        Secondary Dark
                    </div>
                ...
                <Paper className={classes.swatch}>
                    ...
                    <div className={classes.errorDark}>
                        Error Dark
                    </div>
                    <div className={classes.errorLight}>
                        Error Light
                    </div>
                </Paper>
                <Paper className={classes.swatch}>
                    ...
                    <div className={classes.backgroundDefault}>
                        Background Default
                    </div>
                </Paper>
                <Paper className={classes.swatch}>
                    <div className={classes.textDisabled}>
                        Text Disabled
                    </div>
                ...
                <Paper className={classes.swatch}>
                    <div className={classes.actionActive}>
                        Action Active
                    </div>
                    <div className={classes.actionDisabled}>
                        Action Disabled
                    </div>
                    <div className={classes.actionDisabledBackground}>
                        Action Disabled Background
                    </div>
                    <div className={classes.actionHover}>
                        Action Hover
                    </div>
                    <div className={classes.actionSelected}>
                        Action Selected
                    </div>
                </Paper>
                <Paper className={classes.swatch}>
